...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  @ViewChild('cardCvc', { static: true }) cvcElement: ElementRef;
  ...
  ngAfterViewInit() {
    this.stripe = Stripe('pk_test_51L1oBZJuReI3ZmZS9kt0baBO6cSh2yeZuxEp4AGEGyMTDuX3zJY2iOVDvHVbHIaAJIcYoRmKFWkwSvsMZNCcZAp300gHGTatZu');
